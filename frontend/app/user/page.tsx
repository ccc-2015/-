      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>当前使用 mock 数据，后续由 `/api/profile/me` 获取</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-md border border-border p-4">
                <div className="text-sm text-muted-foreground">成绩</div>
                <div className="mt-2 text-2xl font-semibold">{profile.score}</div>
              </div>
              <div className="rounded-md border border-border p-4">
                <div className="text-sm text-muted-foreground">全省位次</div>
                <div className="mt-2 text-2xl font-semibold">{formatNumber(profile.rank)}</div>
              </div>
              <div className="rounded-md border border-border p-4">
                <div className="text-sm text-muted-foreground">科类</div>
                <div className="mt-2 text-2xl font-semibold">{profile.subjectTrack}</div>
              </div>
              <div className="rounded-md border border-border p-4">
